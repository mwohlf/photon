...
public interface Resources {
	...
	public static final ShaderIdentifier SKYBOX_SHADER_ID = ShaderIdentifier.create("shader/skybox/vertex.glsl", "shader/skybox/fragment.glsl");
	...
	public static final ShaderIdentifier PLAIN_SHADER_ID = ShaderIdentifier.create("shader/plain/vertex.glsl", "shader/plain/fragment.glsl");
	public static final ShaderIdentifier TWOD_SHADER_ID = ShaderIdentifier.create("shader/2d/vertex.glsl", "shader/2d/fragment.glsl");
